...
$section_content['section_subtitle'] = get_theme_mod( 'pure_portfolio_skill_section_subtitle', __( 'Ability & Skills', 'impressive-portfolio' ) );
$section_content['section_title']    = get_theme_mod( 'pure_portfolio_skill_section_title', __( 'My Expertise', 'impressive-portfolio' ) );
						...
						for ( $i = 1; $i <= 4; $i++ ) :
							...
							<div class="progressbar-single">
								<div class="progressbar" data-animate="false">
									<div class="circle" data-percent="<?php echo esc_attr( $skill_value ); ?>" data-size="180" data-thickness="12" data-fill="{ &quot;color&quot;: &quot;#ff6762&quot;}" >
									<div></div>
									</div>
								</div>
